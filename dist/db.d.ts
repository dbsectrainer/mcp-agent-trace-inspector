...
export declare function insertTrace(
  db: DatabaseSync,
  id: string,
  name: string,
): void;
export declare function endTrace(db: DatabaseSync, id: string): void;
export declare function insertStep(
  db: DatabaseSync,
  step: Omit<StepRow, "created_at">,
): void;
export declare function getTrace(
  db: DatabaseSync,
  id: string,
): TraceRow | undefined;
export declare function getSteps(db: DatabaseSync, traceId: string): StepRow[];
export declare function listTraces(
  db: DatabaseSync,
  limit?: number,
): TraceRow[];
export declare function deleteOldTraces(
  db: DatabaseSync,
