    ...
    try {
      switch (name) {
        ...
        case "trace_step": {
          ...
          const tokenCount =
            safeArgs.token_count !== undefined ? safeArgs.token_count : 0;
          const costUsd =
            tokenCount > 0
              ? (estimateCost(
                  tokenCount,
        ...
        case "get_trace_summary":
          return handleGetTraceSummary(db, {
            trace_id: safeArgs.trace_id,
            model: safeArgs.model !== undefined ? safeArgs.model : undefined,
          });
        case "list_traces":
          return handleListTraces(db, {
            limit: safeArgs.limit !== undefined ? safeArgs.limit : undefined,
          });
        ...
        case "export_otel": {
          const traceId =
            safeArgs.trace_id !== undefined ? safeArgs.trace_id : undefined;
          let result;
          if (traceId) {
        ...
        case "export_compliance_log": {
          const fromDate =
            safeArgs.from_date !== undefined ? safeArgs.from_date : undefined;
          const toDate =
            safeArgs.to_date !== undefined ? safeArgs.to_date : undefined;
